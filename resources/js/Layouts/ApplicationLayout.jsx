...
export default memo(function ApplicationLayout({
    ...
    return (
        <>
            ...
            >
                {header && <div className="flex py-4">{header}</div>}

                {content && (
                    <div
                        className={`flex flex-col flex-1 h-full overflow-auto py-4 space-y-8 ${contentClassName}`}
                    >
                        {content}
                    </div>
                )}
                ...
                {footer && (
                    <div
                        className={`flex flex-col space-y-8 py-4 bg-white ${footerClassName}`}
                    >
                        {footer}
