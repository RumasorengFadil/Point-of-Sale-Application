    ...
    return (
        <div className="flex flex-col space-y-4 px-4 overflow-auto">
            <div className="flex space-x-4 items-center">
                <div
                    onClick={() => setTab("book")}
                    className={`cursor-pointer transition-all ${tab==="book"?"font-bold border-b-2 border-black":""}`}
                >
                    <h1>Daftar Buku Kas</h1>
                </div>
                <div
                    onClick={() => setTab("flow")}
                    className={`cursor-pointer transition-all ${tab==="flow"?"font-bold border-b-2 border-black":""}`}
                >
